  ...
  return (
    <SliderPrimitive.Root
      ...
      <SliderPrimitive.Track
        ...
        className={cn(
          "bg-control-inactive relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5"
        )}>
