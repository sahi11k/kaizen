...
function DrawerContent({ className, children, fullScreen = false, ...props }) {
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          fullScreen &&
            "!inset-0 !h-[100dvh] !max-h-[100dvh] data-[vaul-drawer-direction=bottom]:!mt-0 data-[vaul-drawer-direction=top]:!mb-0 !rounded-none !border-0",
          className
        )}
        {...props}
      >
